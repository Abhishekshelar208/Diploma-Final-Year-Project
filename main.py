...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\bg3.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Attendance System Using Face Recognition",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\std1.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Student Section",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\hlp.jpg")
        ...
        hlp_b1_1 = Button(bg_img,command=self.helpSupport,text="Support",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\gallary.png")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Data-Sets",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=480,y=510,width=180,height=45)

        # Developers   button 7
        dev_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\dev.jpg")
        ...
        dev_b1_1 = Button(bg_img,command=self.developr,text="Group Members",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=710,y=510,width=180,height=45)

        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\exi.jpg")
...
# ==================Funtion for Open Images Folder==================
    #def open_img(self):
        #os.startfile(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\data_img")
# ==================Functions Buttons=====================
