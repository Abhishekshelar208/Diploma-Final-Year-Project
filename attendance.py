...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\bg2.jpg")
    ...
    #Update button
        ...
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)
    #clear csv button
        del_btn=Button(right_frame,text="Clear CSV",command=self.clear_csv,width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
