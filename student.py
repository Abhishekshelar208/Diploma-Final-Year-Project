...
class Student:
    ...
    # This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Section",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        dep_combo["values"]=("Select Department","IF","CO","CE","ME","AE")
        dep_combo.current(0)
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Year",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        cou_combo["values"]=("Select Year","FY","SY","TY")
        cou_combo.current(0)
        ...
        #label Year
        year_label=Label(current_course_frame,text="Academic-Year",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        year_combo["values"]=("Select Academic Year","2019-21","2020-22","2021-23","2022-24","2023-25")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Select College:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        div_combo["values"]=("Diploma","Degree")
        div_combo.current(0)
        ...
        #Email
        student_email_label = Label(class_Student_frame,text="Enrollment:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Class Teacher:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        self.student_table.heading("Email",text="Enrollment")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_mob.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
    ...
    def reset_data(self):
        ...
        self.var_div.set("Select College"),
            ...
            try:
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path=r"data_img\stdudent."+str(id)+"."+str(img_id)+".jpg"
