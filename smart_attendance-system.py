...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"C:\Users\User\Desktop\FACE-ATTENDACE-SYSTEM\Images_GUI\log1.png")
...
# This part is image labels setting start 
        ...
        hlp_b1 = Button(bg_img,image=self.hlp_img1,cursor="hand2",command=self.helpSupport)
        hlp_b1.place(x=940,y=100,width=180,height=180)

        hlp_b1_1 = Button(bg_img,text="Support",cursor="hand2",command=self.helpSupport,font=("tahoma",15,"bold"),bg="white",fg="navyblue")
